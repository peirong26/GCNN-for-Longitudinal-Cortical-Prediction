...
load('/Users/peirong/Documents/Cycle/036/Results/affine/li_6.mat');
pred_li = pred_6;
load('/Users/peirong/Documents/Cycle/036/Results/affine/lo_6.mat');
pred_lo = pred_6; 
load('/Users/peirong/Documents/Cycle/036/Results/affine/ri_6.mat');
pred_ri = pred_6;
load('/Users/peirong/Documents/Cycle/036/Results/affine/ro_6.mat');
pred_ro = pred_6; 
...
Lh_Inner.Thickness_Error = sqrt(tmp_l) - 0.4*mean(tmp_l);
Lh_Outer.Thickness_Error = sqrt(tmp_l) - 0.4*mean(tmp_l);
Rh_Inner.Thickness_Error = sqrt(tmp_r) - 0.4*mean(tmp_r);
Rh_Outer.Thickness_Error = sqrt(tmp_r) - 0.4*mean(tmp_r);
...
% Write vtk
path_write_vtk_li = fullfile(path_write_vtk, ['Lh_Inner_AF6','.vtk']);
path_write_vtk_lo = fullfile(path_write_vtk, ['Lh_Outer_AF6','.vtk']);
path_write_vtk_ri = fullfile(path_write_vtk, ['Rh_Inner_AF6','.vtk']);
path_write_vtk_ro = fullfile(path_write_vtk, ['Rh_Outer_AF6','.vtk']);
