...
load('/Users/peirong/Documents/Cycle/036/dumps/mat/03/out_in/test_batch_dim=60/ep=1500_for_M000_lh.InnerSurf.mat');
pred_li = pred_3;
load('/Users/peirong/Documents/Cycle/036/dumps/mat/03/out_in/test_batch_dim=60/ep=1500_for_M000_lh.OuterSurf.mat');
pred_lo = pred_3; % typo in python code
load('/Users/peirong/Documents/Cycle/036/dumps/mat/03/out_in/test_batch_dim=60/ep=1500_for_M000_rh.InnerSurf.mat');
pred_ri = pred_3;
load('/Users/peirong/Documents/Cycle/036/dumps/mat/03/out_in/test_batch_dim=60/ep=1500_for_M000_rh.OuterSurf.mat');
pred_ro = pred_3; % typo in python code

% path for writing vtk results
path_write_vtk = '/Users/peirong/Documents/Cycle/036/Results/03';

path_gt_li = '/Users/peirong/Documents/Cycle/TotalData/Surfaces_All/M086-1/03/M086-1_03_lh.InnerSurf.mat';
load(path_gt_li);
gt_li = surface;
path_gt_lo = '/Users/peirong/Documents/Cycle/TotalData/Surfaces_All/M086-1/03/M086-1_03_lh.OuterSurf.mat';
load(path_gt_lo);
gt_lo = surface;
path_gt_ri = '/Users/peirong/Documents/Cycle/TotalData/Surfaces_All/M086-1/03/M086-1_03_rh.InnerSurf.mat';
load(path_gt_ri);
gt_ri = surface;
path_gt_ro = '/Users/peirong/Documents/Cycle/TotalData/Surfaces_All/M086-1/03/M086-1_03_rh.OuterSurf.mat';
load(path_gt_ro);
gt_ro = surface;

% path for reference: 0 month
path_gt_li_0 = '/Users/peirong/Documents/Cycle/TotalData/Surfaces_All/M086-1/00/M086-1_00_lh.InnerSurf.mat';
load(path_gt_li_0);
gt_li_0 = surface;
path_gt_lo_0 = '/Users/peirong/Documents/Cycle/TotalData/Surfaces_All/M086-1/00/M086-1_00_lh.OuterSurf.mat';
load(path_gt_lo_0);
gt_lo_0 = surface;
path_gt_ri_0 = '/Users/peirong/Documents/Cycle/TotalData/Surfaces_All/M086-1/00/M086-1_00_rh.InnerSurf.mat';
load(path_gt_ri_0);
gt_ri_0 = surface;
path_gt_ro_0 = '/Users/peirong/Documents/Cycle/TotalData/Surfaces_All/M086-1/00/M086-1_00_rh.OuterSurf.mat';
load(path_gt_ro_0);
gt_ro_0 = surface;
...
tmp_li = pred_li - ([gt_li.X,gt_li.Y,gt_li.Z] - [gt_li_0.X,gt_li_0.Y,gt_li_0.Z]);
tmp_lo = pred_lo - ([gt_lo.X,gt_lo.Y,gt_lo.Z] - [gt_lo_0.X,gt_lo_0.Y,gt_lo_0.Z]);
tmp_ri = pred_ri - ([gt_ri.X,gt_ri.Y,gt_ri.Z] - [gt_ri_0.X,gt_ri_0.Y,gt_ri_0.Z]);
tmp_ro = pred_ro - ([gt_ro.X,gt_ro.Y,gt_ro.Z] - [gt_ro_0.X,gt_ro_0.Y,gt_ro_0.Z]);
...
err_li = abs(err_li - 0.7*mean(abs(err_li)));
err_lo = abs(err_lo - 0.7*mean(abs(err_lo)));
err_ri = abs(err_ri - 0.7*mean(abs(err_ri)));
err_ro = abs(err_ro - 0.7*mean(abs(err_ro)));
...
% Write vtk
path_write_vtk_li = fullfile(path_write_vtk, ['Lh_Inner_GSM3','.vtk']);
path_write_vtk_lo = fullfile(path_write_vtk, ['Lh_Outer_GSM3','.vtk']);
path_write_vtk_ri = fullfile(path_write_vtk, ['Rh_Inner_GSM3','.vtk']);
path_write_vtk_ro = fullfile(path_write_vtk, ['Rh_Outer_GSM3','.vtk']);
