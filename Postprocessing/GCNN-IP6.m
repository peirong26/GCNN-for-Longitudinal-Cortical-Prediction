...
load('/Users/peirong/Documents/Cycle/036/dumps/mat/06/out_in/06_batch_dim=60/ep=350_for_M038_lh.InnerSurf.mat');
pred_li = pred_6;
load('/Users/peirong/Documents/Cycle/036/dumps/mat/06/out_in/06_batch_dim=60/ep=350_for_M038_lh.OuterSurf.mat');
pred_lo = pred_6; % typo in python code
load('/Users/peirong/Documents/Cycle/036/dumps/mat/06/out_in/06_batch_dim=60/ep=350_for_M038_rh.InnerSurf.mat');
pred_ri = pred_6;
load('/Users/peirong/Documents/Cycle/036/dumps/mat/06/out_in/06_batch_dim=60/ep=350_for_M038_rh.OuterSurf.mat');
pred_ro = pred_6; 
...
Lh_Inner.Thickness_Absolute_Error = 0.7*abs(Lh_Inner.Thickness_Error);
Lh_Outer.Thickness_Absolute_Error = 0.7*abs(Lh_Outer.Thickness_Error);
Rh_Inner.Thickness_Absolute_Error = 0.7*abs(Rh_Inner.Thickness_Error);
Rh_Outer.Thickness_Absolute_Error = 0.7*abs(Rh_Outer.Thickness_Error);
...
% Write vtk
path_write_vtk_li = fullfile(path_write_vtk, ['Lh_Inner_GS6','.vtk']);
path_write_vtk_lo = fullfile(path_write_vtk, ['Lh_Outer_GS6','.vtk']);
path_write_vtk_ri = fullfile(path_write_vtk, ['Rh_Inner_GS6','.vtk']);
path_write_vtk_ro = fullfile(path_write_vtk, ['Rh_Outer_GS6','.vtk']);
